...
class_name StandardDialogBox

export(float) var TEXT_SPEED = 0.05 # text speed
export(String) var dialog = "" # dialog string # TODO : switch to pascal case (but requires a change in Dialog manager script)
export(NodePath) var RTL_PATH # path of the rich text label
...
var RTLTimer # instance of the timer for character display
